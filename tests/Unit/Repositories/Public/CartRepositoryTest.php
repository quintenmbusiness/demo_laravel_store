...
class CartRepositoryTest extends TestCase
{
    ...
    public function test_can_view_cart_items(): void
    {
        ...
        $cart = $this->repository->viewCartItems($this->sessionId);
    ...
    public function test_can_clear_cart(): void
    {
        ...
        $cart = $this->repository->clearCart($this->sessionId);
    ...
    public function test_can_remove_cart_item(): void
    {
        ...
        $this->repository->removeCartItem($cartPopo, $this->sessionId);
    ...
    public function test_can_set_cart_item_quantity(): void
    {
        ...
        $this->repository->setCartItemQuantity($cartPopo, $this->sessionId);
    ...
    public function test_can_add_cart_item_if_non_exists(): void
    {
        ...
        $this->repository->addCartItem($cartPopo, $this->sessionId);
